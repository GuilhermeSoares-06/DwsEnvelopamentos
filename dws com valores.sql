...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23/05/2026 às 14:31
...
INSERT INTO `clientes` (`cliid`, `clinome`, `clicpf`, `cliendereco`, `cliservico`, `clitel`) VALUES
(1, 'Luis Felipe', '573.147.147/57', 'Nova América 27', NULL, '(14) 99675421');
...
CREATE TABLE `usuarios` (
  ...
  `ususalario` varchar(99) DEFAULT NULL,
  `usutipo` enum('adm') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
