...
<body>
    <div class="dashboard">
        ...
        <div class="sidebar-total">
            ...
            <div class="total-value">
                <div class="                <div class="label">VALOR ACUMULADO</div>
                <div class="amount">
            ...
            <div class="total-details">
                ...
                <div class="detail-item">
                    <span class="detail-label"><i class="fas fa-calculator"></i> Ticket Médio</span>
                    <span class="detail-value highlight">R$ <?= $ticket_medio_formatado ?></span>
                </div>
                <div class="detail-item">
                    <span class="detail-label"><i class="fas fa-clock"></i> Última Atualização</span>
                    <span class="detail-value" style="font-size: 12px; color: #666;"><?= date('d/m/Y H:i') ?></span>
                </div>
            </div>
            ...
            <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.05);">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                    <div style="background: rgba(255,255,255,0.03); padding: 12px; border-radius: 10px; text-align: center;">
                        <div style="color: #666; font-size: 11px; text-transform: uppercase;">Média Diária</div>
                        <div style="color: #4CAF50; font-size: 16px; font-weight: 600; margin-top: 4px;">
                            R$ <?= $qtd_total > 0 ? formatBr($total_geral / max(1, ceil($qtd_total / 30))) : '0,00' ?>
                        </div>
                    </div>
                    <div style="background: rgba(255,255,255,0.03); padding: 12px; border-radius: 10px; text-align: center;">
                        <div style="color: #666; font-size: 11px; text-transform: uppercase;">Maior Valor</div>
                        <div style="color: #ff9800; font-size: 16px; font-weight: 600; margin-top: 4px;">
                            <?php
                            $maior = 0;
                            foreach ($todosServicos as $s) {
                                $v = brToDecimal($s['servalor']);
                                if ($v > $maior) $maior = $v;
                            }
                            echo 'R$ ' . formatBr($maior);
                            ?>
                        </div>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateTime() {
            ...
            const timeElement = document.querySelector('.detail-item:last-child .detail-value');
            if (timeElement) {
