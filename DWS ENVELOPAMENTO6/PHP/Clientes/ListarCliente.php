...
function formatarValor($valor, $tipo = 'texto') {
    ...
    if (empty($valor)) {
        switch ($tipo) {
            case 'telefone':
                return '<span style="color: #666; font-style: italic;">Não informado</span>';
            case 'endereco':
                return '<span style="color: #666; font-style: italic;">Não informado</span>';
            case 'cpf':
                return '<span style="color: #666; font-style: italic;">Não informado</span>';
...
// ---- FUNÇÃO PARA VALIDAR SE TEM DADOS ----
function temDados($valor) {
...
<div class="container">
    ...
    <div class="stats-bar">
        ...
        <div class="actions-quick">
            <a class="btn btn-success" href="../../telas/ADM/CadastroCliente.html">Novo Cliente</a>
        </div>
    </div>
                    ...
                    <?php if ($clientes): ?>
                        <?php foreach ($clientes as $r): ?>
                            <tr>
                                ...
                                <td>
                                    <?php 
                                    // CPF com tratamento de vazio
                                    $cpf = trim($r['clicpf'] ?? '');
                                    if (empty($cpf)): ?>
                                        <span class="campo-vazio">Não informado</span>
                                    <?php else: ?>
                                        <span class="cell-cpf"><?= htmlspecialchars($cpf) ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php 
                                    // Telefone com tratamento de vazio
                                    $telefone = trim($r['clitel'] ?? '');
                                    if (empty($telefone)): ?>
                                        <span class="campo-vazio">Não informado</span>
                                    <?php else: ?>
                                        <span class="campo-preenchido"><?= htmlspecialchars($telefone) ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php 
                                    // Endereço com tratamento de vazio
                                    $endereco = trim($r['cliendereco'] ?? '');
                                    if (empty($endereco)): ?>
                                        <span class="campo-vazio">Não informado</span>
                                    <?php else: ?>
                                        <span class="campo-preenchido"><?= htmlspecialchars($endereco) ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
