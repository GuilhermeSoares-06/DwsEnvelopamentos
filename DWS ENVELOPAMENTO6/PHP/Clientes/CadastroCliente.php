...
// -----------------------------------------------------
// Reaproveita paginaErroCadastro() (já definida acima) e a
// validarCPF() de validacao.php (já incluída no topo do arquivo).
// =============================================
if ($cpf === '') {
...
if (!validarCPF($cpf)) {
    paginaErroCadastro('CPF Inválido', 'O CPF informado não é válido. Verifique os números digitados e tente novamente.');
}
