...
<body>
    <div class='container'>
                        ...
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td style='text-align: center'>
                                    <a href='?deletar=<?php echo $row['cliid']; ?>' class='btn-deletar' 
                                    onclick='return confirm("Deletar este pedido?")'>Excluir</a>
                                    <a href='../../telas/ADM/principalFUN.html'></a>
                                    </a>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
                            <td colspan='6' class='sem-clientes'>
                                ...
                                <br><br>
                                <a href='../../telas/Cliente/CadastroCliente.html' style='color: #F23535;'>Clique aqui para cadastrar</a>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
        ...
        <div class='footer-botoes'>
            ...
            <a href='../../telas/Cliente/CadastroCliente.html' class='btn-voltar' style='background: #4CAF50;'>
                Novo Cliente
            </a>
        </div>
    </div>
