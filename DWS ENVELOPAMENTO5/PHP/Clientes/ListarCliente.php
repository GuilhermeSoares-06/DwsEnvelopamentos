<?php
// =============================================
// ListarCliente.php  (área ADM - exige token de funcionário)
// =============================================
require_once __DIR__ . '/../Banco/conexao.php';
require_once __DIR__ . '/../Auth/token.php';

// Proteção: somente funcionários
$me = Token::exigirAdmin(false); // false = redireciona para HTML em vez de JSON
...
<div class="container">
    ...
    <div class="admin-badge"><span>👤 Administrador: <?= htmlspecialchars($me['nome']) ?></span></div>
...
<script>
const token = localStorage.getItem('dws_token') || '';
