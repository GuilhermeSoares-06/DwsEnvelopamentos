...
// ---- Busca ----
// NOVO: agora também aceita ?cliid=X, vindo do botão "🧾 Serviços" da lista de
// clientes (ListarCliente.php). Isso mostra o HISTÓRICO REAL de um cliente específico
// (via chave estrangeira cliid), em vez de depender de busca por nome (que pode
// confundir clientes com nomes parecidos ou não achar por causa de acentos/maiúsculas).
...
<div class="dashboard">
    <div class="main-content">
        ...
        <div class="resultado-info">
            Histórico do cliente: <strong><?= htmlspecialchars($clienteFiltro['clinome']) ?></strong>
            (<?= htmlspecialchars($clienteFiltro['clitel'] ?? '—') ?>)
            — <?= count($servicos) ?> serviço(s)
            &nbsp;<a class="limpar-btn" style="padding:4px 12px" href="GerenciarServico.php">✖ Ver todos</a>
        </div>
        <?php elseif ($busca): ?>
        <div class="resultado-info">
