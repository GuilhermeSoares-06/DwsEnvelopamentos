...
--
-- Host: localhost:3306
-- Generation Time: Mar 20, 2026 at 02:47 PM
...
--
-- Table structure for table `aquaticos`
--
...
--
-- Indexes for table `aquaticos`
--
ALTER TABLE `aquaticos`
...
--
-- AUTO_INCREMENT for table `aquaticos`
--
ALTER TABLE `aquaticos`
...
ALTER TABLE `servicos`
  ...
  ADD CONSTRAINT `servicos_ibfk_5` FOREIGN KEY (`barid`) REFERENCES `aquaticos` (`barid`),
